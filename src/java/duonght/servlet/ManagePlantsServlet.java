...
public class ManagePlantsServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            ArrayList<Plant> plants = PlantDao.getAllPlants();
            ArrayList<Plant> avl = PlantDao.getPlantByStatus(1);
            ArrayList<Plant> oos = PlantDao.getPlantByStatus(0);
            request.setAttribute("plants", plants);
            request.setAttribute("avl", avl);
            request.setAttribute("oos", oos);
