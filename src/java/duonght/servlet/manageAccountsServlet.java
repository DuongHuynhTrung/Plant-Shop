...
public class manageAccountsServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            ArrayList<account> accounts = accountDao.getAccountsExcept(email);
            ArrayList<account> users = accountDao.getAccountByRole(0);
            ArrayList<account> admins = accountDao.getAccountByRole(1);
